...
public class CameraRecorder {
    ...
    private int channelConfig = AudioFormat.CHANNEL_IN_MONO;   //音频录制通道,默认为立体声
...
//    private byte[] mHeadInfo=null;
    ...
    public int prepare(int width, int height) throws IOException {
        ...
        bufferSize = AudioRecord.getMinBufferSize(sampleRate, channelConfig, audioFormat) * 10;
...
//        mHeadInfo=null;
    ...
    private int[] mSampleRates = new int[]{44100}; //8000, 11025, 22050,
        ...
        for (int rate : mSampleRates) {
            for (short audioFormat : new short[]{
                ...
                for (short channelConfig : new short[]{
                    ...
                    try {
                        Log.e("Mic2", "Attempting rate " + rate
                                + "Hz, bits: " + audioFormat
                                + ", channel: " + channelConfig);
                        bufferSize = AudioRecord.getMinBufferSize(rate,
                                channelConfig, audioFormat) * 10;
                        Log.e("Mic20", bufferSize + "");
                        if (bufferSize != AudioRecord.ERROR_BAD_VALUE) {
                            ...
                            if (state == AudioRecord.STATE_INITIALIZED) {
                                sampleRate = rate;
                                Log.e("Mic21", "Attempting rate " + rate
                                        + "Hz, bits: " + audioFormat
                                        + ", channel: " + channelConfig);
                                return recorder;
                            }
                        ...
                        Log.e("Mic2", rate + "Exception, keep trying.", e);
                    }
                }
            }
        }
